...
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrAkidIssuerSerialMismatch;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrAkidSkidMismatch;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrApplicationVerification;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCertChainTooLong;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCertHasExpired;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCertNotYetValid;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCertRejected;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCertRevoked;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCertSignatureFailure;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCertUntrusted;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCrlHasExpired;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCrlNotYetValid;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCrlPathValidationError;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrCrlSignatureFailure;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrDaneNoMatch;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrDepthZeroSelfSignedCert;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrDifferntCrlScope;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrEmailMismatch;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrErrorInCertNotAfterField;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrErrorInCertNotBeforeField;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrErrorInCrlLastUpdateField;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrErrorInCrlNextUpdateField;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrExcludedViolation;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrHostnameMismatch;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrInvalidCa;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrInvalidExtension;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrInvalidNonCa;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrInvalidPolicyExtension;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrInvalidPurpose;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrIpAddressMismatch;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrKeyUsageNoCertSign;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrKeyUsageNoCrlSign;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrKeyUsageNoDigitalSignature;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrNoExplicitPolicy;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrOutOfMem;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrPathLengthExceeded;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrPathLoop;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrPermittedViolation;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrProxyCertificatesNotAllowed;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrProxyPathLengthExceeded;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSelfSignedCertInChain;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSubjectIssuerMismatch;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSubtreeMinMax;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSuiteBCannotSignP384WithP256;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSuiteBInvalidAlgorithm;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSuiteBInvalidCurve;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSuiteBInvalidSignatureAlgorithm;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSuiteBInvalidVersion;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrSuiteBLosNotAllowed;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnableToDecodeIssuerPublicKey;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnableToDecryptCertSignature;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnableToDecryptCrlSignature;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnableToGetCrl;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnableToGetCrlIssuer;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnableToGetIssuerCert;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnableToGetIssuerCertLocally;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnableToVerifyLeafSignature;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnhandledCriticalCrlExtension;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnhandledCriticalExtension;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnnestedResource;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnspecified;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnsupportedConstraintSyntax;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnsupportedConstraintType;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnsupportedExtensionFeature;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vErrUnsupportedNameSyntax;
import static io.netty.internal.tcnative.NativeStaticallyReferencedJniMethods.x509vOK;
